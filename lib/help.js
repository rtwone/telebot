...
exports.start = async(lol, name) => {
    text = `Hello ${name}! Im a multifunction bot created with ❤️ by @rtwone`
    await lol.replyWithMarkdown(text, { disable_web_page_preview: true })
    teks = 'Type /help to display the bot menu'
    await lol.replyWithMarkdown(teks, { disable_web_page_preview: true })
